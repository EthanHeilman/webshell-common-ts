...
export interface KubeTunnelPolicyCreateRequest {
     /**
     ...
     description?: string;
     /**
      * Environments this policy applies to.                A value must be provided for either <code>environments</code> or <code>clusters</code>.
      */
     environments?: Environment[];
     /**
      * Clusters this policy applies to.                A value must be provided for either <code>clusters</code> or <code>environments</code>.
      */
     clusters?: Cluster[];
     /**
